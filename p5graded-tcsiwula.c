/*
***Correctness***         
Does the program accept the required command line arguments: r, s, m, n, max, ig? 6 / 6   
If the command line option 'i' is given, does it correctly read the input world?  3 / 3   
If the command line option 'g' is given, does it correctly generate a "random" world? 3 / 3   
Correctly partition the world among the threads.  10  / 10    
Counts generations correctly. Input/random generation is generation 0.  5 / 5   
Correctly detect that all the cells have died and then terminate. 5 / 5   
          
Test A: r = s = 1.  4 / 4   
Test A: r = 2, s = 1. 5 / 5   
Test A: r = 1, s = 2. 0 / 5   Missing Generation 3; Error in free(): "invalid next size"
Test A: r = 2, s = 2. 0 / 5   Missing Generation 4.
          
Test B: r = s = 1.  4 / 4   
Test B: r = 2, s = 2. 5 / 5   
Test C: prob = 0.1. 0 / 5   Incorrect Generation 1.
          
###Total Correctness###   50  / 65  
...
***Quality of solution***         
Correct allocation and deallocation of storage. 6 / 6   
"Do the synchronization with a condition variable,
       a mutex, and a counter -- as opposed to a pthreads
       barrier, semaphores, or busy waiting." 7 / 7   
Implementation of thread synchronization. 7 / 7   
###Total Quality###   20  / 20  
